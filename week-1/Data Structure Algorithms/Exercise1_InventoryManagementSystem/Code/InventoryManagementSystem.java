...
public class InventoryManagementSystem {
    ...
    public static void main(String[] args) {
        ...
        inv.addProduct(new Product(1, "Monitor", 15, 300500.00));
        inv.addProduct(new Product(2, "Mouse", 100, 25000.00));
        inv.addProduct(new Product(3, "Keyboard", 600, 75000.00));
        ...
        inv.updateProduct(2, 46, 29000.50);
